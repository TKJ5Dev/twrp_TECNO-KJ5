...
BOARD_DTB_SIZE := 182257
BOARD_DTB_OFFSET := 0x0bc08000
BOARD_FLASH_BLOCK_SIZE := 262144 # (BOARD_PAGESIZE * 64)

BOARD_MKBOOTIMG_ARGS += --board "TECNO-KJ5"
...
BOARD_MAIN_SIZE := 0x200C00000 # (BOARD_SUPER_PARTITION_SIZE - 4MB)
BOARD_TECNO_DYNAMIC_PARTITIONS_SIZE := 0x200C00000 # (BOARD_SUPER_PARTITION_SIZE - 4MB)
...
TW_DEFAULT_DEVICE_NAME := TECNO-KJ5
TW_DEVICE_VERSION := Twrp by Re6ee or TKJ5Dev
